...
{
    public class ProjectileExplosiveCrate : ProjectileBase
    {
        [Header("General")]
        ...
        void OnHit(Vector3 point, Vector3 normal, Collider collider)
        {
            ...
            {
                // area damage
                AreaOfDamage.InflictDamageInArea(Damage, transform.position, HittableLayers, k_TriggerInteraction,
            ...
            if (ImpactVfx)
            {
                //GameObject impactVfxInstance = Instantiate(ImpactVfx, ImpactVfx.transform.position, this.transform.rotation, this.transform);
